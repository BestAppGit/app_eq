...
Cria um `DynamicsProcessing` na sessão global `0` com 11 bandas de cutoff entre `55 Hz` e `65 Hz`, aplicando `-12 dB` em `59 Hz` no Pre-EQ. Este é o modo legado que produziu alteração audível no Redmi Note 14.
